#!/usr/bin/env python3
"""Bootstrap a reusable research workspace skeleton with idempotent behavior."""
...
## Directory Layout
- `research/plans/`: active pointer, master plan, milestone plans, bootstrap prompt.
...
def render_session_bootstrap_prompt() -> str:
...
def build_file_map(root: Path, slug: str, today: str) -> Dict[Path, str]:
    return {
        ...
        root / "research" / "plans" / "session_bootstrap_prompt_zh.md": render_session_bootstrap_prompt(),
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Bootstrap a reusable research workspace skeleton."
    )
    parser.add_argument(
        "--workspace-root",
        type=Path,
...
def main() -> int:
    ...
    print("Research workspace bootstrap complete")
